...
.\Create-SelfSignedCertificate.ps1 -CommonName "SEF2023" -StartDate 2023-09-12 -EndDate 2025-09-11 -Password (ConvertTo-SecureString "pass@word1" -Force -AsPlainText)
...
# Doesn't actually work, but shows how to only get non system libraries
...
# Doesn't work either, but shows how to get extended properties and create a custom object
$docliblist = Get-PnPList -Includes DefaultViewUrl,IsSystemList | Where-Object -Property IsSystemList -EQ -Value $false | Where-Object -Property BaseType -EQ -Value "DocumentLibrary"
